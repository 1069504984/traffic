...
class TestSuite(TaskSequence):
    ...
    def on_start(self):
        ...
        """
        self.uuid = random.randint(10000000000000, 10000000000000000000000000000000)
        self.uuid = str(self.uuid)
        # self.headers = {"Content-Type": "application/json"}
        self.objext_type = 3

        self.httpurl = "http://172.16.1.138:6091/rebalance/message"
        self.big_img = "http://172.16.1.138:8891/group1/M00/05/02/rBABil9W4vqAe-85AADw-_QWCoQ501.jpg"
